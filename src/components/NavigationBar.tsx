...
import { getSlideUrl, shareUrl } from "../utils/urlUtils";
...
const NavigationBar: React.FC<NavigationBarProps> = ({ onSettingsOpen }) => {
  ...
  const { controlBarPosition, wrapNavigation } = useAppSelector(
  ...
  const getPositionClasses = () => {
    const baseClasses =
      "fixed bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg p-4 z-50 transition-all duration-200";

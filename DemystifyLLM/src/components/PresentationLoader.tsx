    ...
    <div className="w-full max-w-2xl mx-auto p-6 animate-fade-in">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Load a presentation from GitHub Gist or try our demo with interactive labs
        </p>
      </div>

      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="space-y-3">
          <label htmlFor="gist-url" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
            GitHub Gist URL
          </label>
      ...
      {loading.error && (
        <div className="mt-6 p-4 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-300 rounded-lg animate-shake">
          <div className="flex items-start">
            <span className="text-red-600 dark:text-red-400 text-lg mr-3 flex-shrink-0">⚠️</span>
            <div>
              <h4 className="font-medium text-red-800 dark:text-red-200 mb-1">Failed to Load Presentation</h4>
      ...
      {gistUrl && !loading.error && (
        <div className="mt-6 p-4 bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 text-green-700 dark:text-green-300 rounded-lg animate-fade-in">
          <div className="flex items-start">
            <span className="text-green-600 dark:text-green-400 text-lg mr-3 flex-shrink-0">✅</span>
            <div>
              <h4 className="font-medium text-green-800 dark:text-green-200 mb-1">Presentation Loaded Successfully!</h4>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-xl animate-fade-in">
            <div className="text-center">
              ...
              <h3 className="text-lg font-medium text-gray-800 dark:text-gray-200 mb-2">Loading Presentation</h3>
